...
global $rootpath, $bgcolor, $conference_name, $general_mail, $copyright_author;
global $copyright_year,$link_author,$conference_logo, $colorBorder;
...
//	The directory must be created and give the specific permissions 
//	in order to apache can write inside that directory
*/
$archivos = "$rootpath/docs";

// The mail to provide users who have PROBLEMS, WARNINGS with Yacomas.
$adminmail='linuxcampeche@gmail.com';

/*
//	The mail to provide to all the users, and the mail that will be used to send mails for 
//	New account or reset account.
*/
$general_mail='contacto@linuxcampeche.mx';

// The name for the conference where yacomas is used
$conference_name = "Festival Latinoamericano de Instalaci&oacute;n de Software Libre Campeche 2012";
...
$conference_link="http://localhost/public/ayam";
...
$image_ponente_dest       = '../images/fotos/ponentes/';
...
$prop_detalles_requeridos = " Your speach to notify the speaker that a conference need details to be properly evaluated,
...
////Cada fichero tendrá la siguiente nomenclatura
