            ...
            <div id="footer">
                <div id="plataform">
                    <a href="http://yacomas.sourceforge.net/" target="_blank" title="Created with YACOMAS">
                        <img title="Created with YACOMAS" alt="YaCOMAS" src="<?php echo "$rootpath/images/buttons/yacomas-micro.png"; ?>" />
                    </a>
                    <a href="http://www.php.net/" target="blank" title="Pumped through PHP">
                        <img title="Pumped th/rough PHP" alt="PHP" src="<?php echo "$rootpath/images/buttons/php.png"; ?>" />
                    </a>
                    <a href="http://www.gnu.org/" target="blank" title="Fueled by GNU software">
                        <img title="Fueled by GNU software" alt="GNU" src="<?php echo "$rootpath/images/buttons/gnu-powered.png"; ?>" />
                    </a>
                    <a href="http://www.mysql.com/products/mysql/" target="blank" title="MySQL under the hood">
                        <img title="Fueled by GNU software" alt="GNU" src="<?php echo "$rootpath/images/buttons/mysql-power-micro.png"; ?>" />
                    </a>
                </div>
