...
print '<table width=100%> <tr>
	...
	// Si la ponencia ya fue modificada o actualizada el status 
	// por algun administrador poner el correo del administrador que acualizo su status
	// para que el ponente sepa con quien dirigirse
	if ($registro['I_id_administrador'] !=0 ) 
	{ 	
		print '
		<tr>
		<td class="name">Correo de contacto: * </td>
		<td class="resultado">';
		$query = 'SELECT mail FROM administrador WHERE id="'.$registro['I_id_administrador'].'"';
		$result=mysql_query($query);
