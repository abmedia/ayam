...
// o para corregir datos que ya hayamos tratado de introducir
    print'
        ...
        <p class="yacomas_error" style="height: 35px">Asegúrate de escribir bien tus datos personales ya que estos 
...
//imprimeCajaBottom(); Aquí todo bien, se cierran divs del cuerpo
print '</div>';
imprimePie(); 
?>
