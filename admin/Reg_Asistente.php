...
$link=conectaBD();
$userQuery = "SELECT id FROM asistente WHERE login='".$_GET['login']."'";
...
if ($stat_array==0) {
    ...
    print ' <p class="elementocentrado">
...
// // Creamos los indices
    ...
    for ($comparado=0,$i=0; $i < $r; $i++,$comparado++) {
        ...
        if ($conflicto!=1)
            ...
            $errmsg='<li>Existen conflictos de cruce de horarios entre los tallere a los que intentas 
                inscribirte y/o los talleres que tienes inscritos'.$errmsg2;
            break;
        }
    }
}
